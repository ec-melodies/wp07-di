...
if [[ $CRS32662 == AOI1 ]] ; then
	grep "Cx_AOI1" $AOIX > $ZDIR/list_isd_dx1.txt;
	echo $CRS32662

elif [[ $CRS32662 == AOI2 ]] ; then
	grep "Cx_AOI2" $AOIX > $ZDIR/list_isd_dx1.txt;
	echo $CRS32662

elif [[ $CRS32662 == AOI3 ]] ; then
	grep "Cx_AOI3" $AOIX > $ZDIR/list_isd_dx1.txt;
	echo $CRS32662

elif [[ $CRS32662 == AOI4 ]] ; then 
	grep "Cx_AOI4" $AOIX > $ZDIR/list_isd_dx1.txt;
	echo $CRS32662
else
