...
export -p OUT001=$OUT/AOI1/AOI1_CX/
mkdir -p $OUT001
...
export -p INDIR001=$DIR/ISD000/CM001/AOI1/AOI1_CX/

export -p OUTDIR000=$DIR/ISD000/SPPV001/
export -p OUTDIR001=$OUTDIR000/AOI1/SX
mkdir -p $OUTDIR001
...
#pkcrop -i large.tif $(pkinfo -i small.tif -bb) 
#extract image band
#-------------------------------------------------------------------------------------# 
...
gdal_translate -projwin $ulx $uly $lrx $lry -of GTiff $OUTDIR000/NIR.tif $OUTDIR001/${filename}_NIR.tif 
gdal_translate -projwin $ulx $uly $lrx $lry -of GTiff $OUTDIR000/RED.tif $OUTDIR001/${filename}_RED.tif 
gdal_translate -projwin $ulx $uly $lrx $lry -of GTiff $LAND001  $OUTDIR001/${filename}_LULC.tif 
done
#-------------------------------------------------------------------------------------# 
exit 0
