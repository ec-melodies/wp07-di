...
export -p LAND001=~/data/ISD/ISD000/VITO
#-------------------------------------------------------------------------------------#
# Sample
#-------------------------------------------------------------------------------------#
for file in $LAND001/*COVER_01.tif ; do 
...
list.filenames<-list.files(pattern="COVER_01.txt$")
...
#list all files from the current directory
list.filenames02<-list.files(pattern="COVER_01.tif$")  
