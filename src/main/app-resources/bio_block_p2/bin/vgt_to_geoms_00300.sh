...
h=$((h+1))
Cx001=$VITO/${filename/#Vx001__crop/INFO_LC_004}.txt
echo $Cx001
...
# Get the same boundary information_globcover
h=$((h+1))
Cx001=$VITO/${filename/#Sx001__crop/INFO_LC_004}.txt
echo $Cx001
...
# Get the same boundary information_globcover
h=$((h+1))
Cx001=$VITO/${filename/#Bx001/INFO_LC_004}.txt
echo $Cx001
...
output003=$LDIR/${filename/#Bx001_/Bx002_}.tif
output004=$ZDIR/${filename/#Bx001_/Bx002_}.tif
echo $output003 
...
xy01<-cbind(x,y)
#-------------------------------------------------------------------------------------# 
sdf0111103 <-cbind(xy01,sdf003$values)
rm(sdf003)
write.table(sdf0111103[,c(3:3)],paste(path=OUTDIR,'/' ,'Bx0100003_',h,'.dat',sep = ""),  row.names = FALSE, col.names = FALSE)
#write.table(sdf0111103,paste(path=OUTDIR,'/' ,'Bx0100004_',h,'.dat',sep = ""),  row.names = FALSE, col.names = FALSE)
rm(sdf0111103)
}
EOF
#-------------------------------------------------------------------------------------#
